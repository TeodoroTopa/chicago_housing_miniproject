...
class ApartmentSpider(scrapy.Spider):
    ...
    def parseListings( self, listings, neighborhood):
        for apt in listings:
    ...
    def parsePostingPage( self, response):
        ...
        self.parseListings(listings, neighborhood)

apartments = pd.read_csv('apt_train_dist.csv')

master_urls = apartments['property_link']
...
df.to_csv('apartments_w_baths_sqft.csv', index= False)
